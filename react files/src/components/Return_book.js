...
class Return_book extends Component {
    constructor(props) {
        super(props);
        this.state = {
...
handleSubmit(event) {
    ...
    request.open('POST', 'http://localhost/biblioteka_uros/php_files/book_return.php?knjiga='+this.state.knjiga+'&id='+cookieValueId+'&status='+cookieValueStatus, false);
    request.send();
